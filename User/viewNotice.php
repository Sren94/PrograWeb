<!-- <?php
   ...
   if ($encontrado)  
   {
       ...
       $noticia=$noticiaModelo->getById($idN);
...
<head>
  ...
  <link rel="stylesheet" href="../css/viewNotice.css" type="text/css" />
</head>
<body>
...
<strong>Autor:</strong>
  ...
  <div class="button-regresar">
    <a  href="homeUser.php" role="button"><i class="fa-solid fa-arrow-left" style="color: #c02a39;"></i><a>
  </div>
  </div>
</body>
</html>
